...
class Environment_drl:
    def __init__(self, game, level):
        ...
        self.states = np.zeros((self.state_vector_width, self.state_vector_height), dtype=np.float32)
    ...
    def perform_frame_update(self):
        ...
        f_door_location = [[self.fire_door_location[0], self.fire_door_location[1], -16, -32]]
        self.update_states(f_door_location, 7)

        w_door_location = [[self.water_door_location[0], self.water_door_location[1], -16, -32]]
